                    ...
                    <tbody>
                        <template x-for="user, index in filteredUsers" :key="user.id">
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-6 py-3 border-b border-slate-200 text-sm font-semibold"><div></div></td>
                    ...
                    <div
                        ...
                        <form @submit.prevent="submitForm" x-data="passwordMatch()">
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-12">
                                ...
                                <div class="sm:col-span-12">
                                    <label for="branch_id" class="block text-sm font-medium text-gray-900">Cabang</label>
                                    <select id="branch_id" name="branch_id" x-model="form.branch_id"
